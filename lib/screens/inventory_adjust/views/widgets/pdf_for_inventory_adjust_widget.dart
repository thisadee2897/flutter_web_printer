                    ...
                    child: pw.SizedBox(
                      ...
                      child: pw.Column(
                        ...
                        children: [
                          ...
                          //             padding: const pw.EdgeInsets.only(right: 10),
                          //             child: pw.Text(
                          //               num.parse(hd.adjustHdAmount ?? '0').digits(2),
                          ...
                          //         pw.Text(NumberToThaiWords.convert(double.parse(hd.adjustHdNetamount ?? '0')), style: textStyleBold),
                          //       ],
                          //     ),
                          //     pw.Padding(
                          //       padding: const pw.EdgeInsets.only(right: 10),
                          ...
                          //           pw.Text(double.parse(hd.adjustHdNetamount ?? '0').digits(2), style: textStyleBold),
                          //         ],
                          //       ),
                          //     ),
                          //   ],
